...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/sync/insumos", post(sync_insumo))
        .route("/sync/pull/insumos", get(pull_insumos))
        .route("/sync/insumo-movements", post(sync_insumo_movement))
        .route("/sync/pull/insumo-movements", get(pull_insumo_movements))
        ...
        .route("/sync/treasury-movements", post(sync_treasury_movement))
        .route("/sync/pull/treasury-movements", get(pull_treasury_movements))
